        ...
        <div className="relative overflow-hidden rounded-3xl bg-white border border-[#173B4D]/15 p-6 sm:p-12 text-center shadow-sm">
          ...
          <div className="my-5 sm:my-6 mx-auto max-w-md rounded-2xl bg-[#FAF8F5] border border-[#173B4D]/20 p-6 sm:p-8 shadow-xs text-center">
            ...
            <div className="mt-2 flex items-baseline justify-center gap-1.5 whitespace-nowrap">
              ...
              <span className="text-7xl sm:text-8xl lg:text-9xl font-black tracking-tight leading-none text-[#173B4D]">
                47
              </span>
              <span className="text-2xl sm:text-3xl lg:text-4xl font-bold accent-serif text-[#B08830] self-end mb-2 sm:mb-3">
                ,00
          ...
          {/* CTA Button (High conversion green, clean and elegant) */}
          <div className="mt-6 sm:mt-8">
            <a
              href={checkoutUrl}
              target="_self"
              id="offer-cta-btn"
              className="inline-flex w-full items-center justify-center gap-2.5 rounded-xl bg-[#1e824c] hover:bg-[#166534] active:bg-[#14532d] py-5 px-6 sm:px-8 text-base sm:text-xl font-bold uppercase tracking-wider text-white shadow-md hover:shadow-lg transition-all duration-200 cursor-pointer"
            >
