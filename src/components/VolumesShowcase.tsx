    ...
    <section id="o-que-voce-vai-receber" className="bg-white px-5 py-16 sm:py-20">
      <div className="mx-auto max-w-6xl">
        ...
        <div className="text-center">
          ...
          <h2 className="mt-3 mx-auto max-w-4xl font-heading text-2xl font-bold leading-snug tracking-tight sm:text-4xl lg:text-5xl sm:leading-tight text-foreground text-balance break-words">
            ...
            return (
              ...
              >
                ...
                <div className="flex flex-col justify-center">
                  ...
                  <h3 className="mt-2 font-heading text-2xl font-bold tracking-tight sm:text-3xl text-foreground">
                    {volume.title}
                  </h3>
        ...
        <div className="mt-14 sm:mt-16 mx-auto max-w-2xl rounded-2xl bg-[#FAF8F5] p-6 sm:p-8 border border-[#EAE5DB] shadow-soft text-center">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-3.5 text-left">
            {SUMMARY_ITEMS.map((item, idx) => (
              <div key={idx} className="flex items-center gap-2.5 rounded-lg bg-white p-3 border border-[#EAE5DB] shadow-xs">
                <div className="flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-emerald-100 text-emerald-600 border border-emerald-300">
