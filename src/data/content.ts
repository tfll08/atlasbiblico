...
export const VOLUMES_DATA: VolumeItem[] = [
  {
    ...
    phrase: 'Cidades, regiões, rios, montanhas, territórios e grandes cenários bíblicos.',
    description: 'Cidades, regiões, rios, montanhas, territórios e grandes cenários bíblicos apresentados com mapas claros e contextualizados.',
    accentColor: '#1B4958',
    badge: 'Volume 1',
  ...
  },
  {
    ...
    phrase: 'Jornadas de Abraão, Isaque, Jacó e José, além do Êxodo e do caminho até Canaã.',
    description: 'Jornadas de Abraão, Isaque, Jacó e José, além do Êxodo e do caminho até Canaã apresentados por rotas e contextos visuais.',
    accentColor: '#8C4827',
    badge: 'Volume 2',
  ...
  },
  {
    ...
    phrase: 'Lugares, regiões e trajetos relacionados à vida e ao ministério de Jesus.',
    description: 'Lugares, regiões e trajetos relacionados à vida e ao ministério de Jesus com visualização dos passos em cada região.',
    accentColor: '#B08830',
    badge: 'Volume 3',
  ...
  },
  {
    ...
    phrase: 'Acompanhe a expansão da mensagem pelo mundo mediterrâneo.',
    description: 'Antioquia, Chipre, Ásia Menor, Macedônia, Grécia, Éfeso, Malta, Roma e os principais trajetos missionários de Paulo.',
    accentColor: '#2B5349',
    badge: 'Volume 4',
